...
void main() {
  ...
  setUpAll(() async {
    ...
    // Create a bucket with random id
    documentReference = cloudStoreClient.collection('users').doc();
    // Set mock data for bucket with ramdomly generated id
    ...
    // Create Mock user with generated id above
    mockUser = MockUser()..uid = documentReference.id;
    // Create Mock Credential with Mock User
    ...
    // Set default return when get currentUser
